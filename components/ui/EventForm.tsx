  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await fetch(`https://formsubmit.co/ajax/${MASKED_EMAIL}`, {
        ...
        body: JSON.stringify({ ...values, _cc: CC_EMAIL, _captcha: 'false', _subject: 'New Register for Event' }),
      });

      Swal.fire({
        icon: 'success',
        title: 'Registration sent',
        text: 'Thank you for registering! We will review your information and get back to via email as soon as possible.',
