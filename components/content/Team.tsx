...
export const Team = ({ id = '' }) => {
  return (
    <>
      ...
      <section
        id="team"
        className={`${style['board-members']} ${sectionStyle['section-bg']} my-5`}>
        <div className="container" data-aos="fade-up">
          ...
          <div className="row d-flex justify-content-center">
            <div
              className="col-lg-3 col-md-6 d-flex align-items-stretch mb-4"
              data-bs-toggle="modal"
              data-bs-target="#monaModal">
              <div
                ...
                <div className={style['member-img']}>
                  <Image
                    src="/assets/images/board-members/mona.jpg"
                    width={218}
                    height={280}
                    className="img-fluid"
                    alt=""
          ...
          <div className="row">
            <div
              ...
              <div
                ...
                <div className={style['member-img']}>
                  <Image
                    src="/assets/images/board-members/mina.jpg"
                    width={218}
                    height={280}
                    className="img-fluid"
                    alt=""
            ...
            <div
              ...
              <div
                ...
                <div className={style['member-img']}>
                  <Image
                    src="/assets/images/board-members/chloe.jpg"
                    width={218}
                    height={280}
                    className="img-fluid"
                    alt=""
            ...
            <div
              ...
              <div
                ...
                <div className={style['member-img']}>
                  <Image
                    src="/assets/images/board-members/yipin.jpg"
                    width={218}
                    height={281}
